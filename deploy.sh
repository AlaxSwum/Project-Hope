...
echo ""
echo "🌐 Your application should be accessible at: http://$SERVER_HOST"
...
echo ""
echo "⚠️  Important: Update your .env.production file with production values before the application will work correctly!"